...
case class DONORS(`age_at_recruitment`: String = "62",
...
case class FOLLOW_UPS(`days_to_follow_up`: Long = 65,
...
case class FILES(`biospecimen`: List[BIOSPECIMEN] = List(BIOSPECIMEN()),
...
case class EXPOSURES(`FSA`: String = "H1K",
